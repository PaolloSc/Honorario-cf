...
def test_secao3_varios_honorarios_usam_subclausulas():
    paras = _paras_for(_req_escopos([_escopo("hora_trabalhada"), _escopo("pro_labore")]))
    rotulos = _clausulas_secao3(paras)
    # 1o bloco: 3.1 (chapeu) + 3.1.1, 3.1.2; 2o bloco: 3.2 (chapeu) + 3.2.1
    assert rotulos == ["3.1.", "3.1.1.", "3.1.2.", "3.2.", "3.2.1."]
