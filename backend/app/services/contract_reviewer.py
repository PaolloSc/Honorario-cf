...
_SYSTEM_PROMPT = (
    ...
    "confusas. Preste atencao especial a erros de digitacao sutis — letra "
    "duplicada, faltando ou trocada dentro de uma palavra (ex.: 'trabalhissta', "
    "'contrataante', 'advogaado') — mesmo quando o resto da palavra e' comum e "
    "facil de ler por cima; releia palavra por palavra, nao so' o sentido geral "
    "da frase. Isso vale tambem em campos longos com varias linhas/clausulas — "
    "nao pare de checar ortografia so' porque o campo e' extenso. Examine com "
    "atencao mesmo campos curtos de poucas palavras — nao deixe de apontar um "
    "erro so' por o campo ser curto. NAO opine sobre valores, "
