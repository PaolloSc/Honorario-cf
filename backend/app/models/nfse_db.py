...
class NFSeRecebidaDB(Base):
    ...
    iss_retido = Column(Numeric(12, 2), nullable=False, default=0, server_default="0")
    irrf = Column(Numeric(12, 2), nullable=False, default=0, server_default="0")
    pis = Column(Numeric(12, 2), nullable=False, default=0, server_default="0")
    cofins = Column(Numeric(12, 2), nullable=False, default=0, server_default="0")
    csll = Column(Numeric(12, 2), nullable=False, default=0, server_default="0")
    valor_liquido = Column(Numeric(12, 2), nullable=False)
    discriminacao = Column(Text, nullable=True)
    cancelada = Column(Boolean, nullable=False, default=False, server_default="0")
...
class SyncJobDB(Base):
    ...
    total_nfs = Column(Integer, nullable=False, default=0, server_default="0")
    auto_vinculadas = Column(Integer, nullable=False, default=0, server_default="0")
    pendentes = Column(Integer, nullable=False, default=0, server_default="0")
    sem_match = Column(Integer, nullable=False, default=0, server_default="0")
